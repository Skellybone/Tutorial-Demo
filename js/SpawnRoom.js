class SpawnRoom extends baseScene {
    ...
    create() {
        ...
        this.gameScene = 'SpawnRoom'
        if (typeof baseScene.Path == 'undefined') {
            baseScene.Path = ['SpawnRoom']
        }
        ...
        this.exitDone
        //Tilemap creation
        this.map = this.make.tilemap({ key: 'Spawn' })
        //World bounds
